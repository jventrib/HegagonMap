...
*/
    ...
    public void draw(GL10 gl, Matrix4 scaleM) {
        ...
        if (visible && Preferences.drawMap) {
            ...
            m.preTranslate(posx, posy);
            if (image != null) {
                if (image.bmp != null && image.isLoaded()) {
    ...
    void correctMapImage(boolean fadeIn, Context context) {
        ...
        this.updateMapImage(fadeIn, context);
    }
...
//		image.state = LoadState.CLEARED;
    ...
    void updateMapImage(boolean fadeIn, Context context) {
        ...
        if (!vis) {
            ...
            if (image == null) {
                ...
                image = new Image(calcTileSrc, cacheFileName, fadeIn, this, context);
...
//                square.loadGLTexture(image.bmp);
                ...
                String calcTileSrc = calcTileSrc();
                String cacheFileName = calcCacheName();
                image.update(calcTileSrc, cacheFileName, fadeIn, this, context);
//                mCanvas = new Canvas(image.bmp);
